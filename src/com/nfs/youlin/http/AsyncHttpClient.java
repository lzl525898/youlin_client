...
//        	 sslSocketFactory = SSLCustomSocketFactory.getSocketFactory(context);
        	
					try {
						SSLContext sslContext = SSLContext.getInstance("TLS");
						InputStream ins = null;
						if (AsyncHttpClient.context!=null){
							ins = AsyncHttpClient.context.getAssets().open("youlin.cer");
						}else{
							ins = InitTransparentActivity.am.open("youlin.cer");
						}
//							InputStream ins = InitTransparentActivity.am.open("youlin.cer");
							try {
							        ...
							        ins.close();
							        AsyncHttpClient.context = null;
							}
					} catch (KeyManagementException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
						Loger.i("LYM", "111111111111111111");
					} catch (UnrecoverableKeyException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
						Loger.i("LYM", "22222222222");
					} catch (NoSuchAlgorithmException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
						Loger.i("LYM", "3333333333");
					} catch (CertificateException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
						Loger.i("LYM", "4444444444");
					} catch (KeyStoreException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
						Loger.i("LYM", "5555555555");
					} catch (NoSuchProviderException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
						Loger.i("LYM", "6666666666");
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
						Loger.i("LYM", "7777777777");
					}
...
//        httpClient=HttpClientHelper.getHttpClient();
    ...
    public RequestHandle post(String url, RequestParams params, ResponseHandlerInterface responseHandler) {
    	...
    	StringBuilder builderWithKey = new StringBuilder();
    	List<BasicNameValuePair> lparams = params.getParamsList();
    	for(BasicNameValuePair valuePair : lparams){
    		builderWithInfo.append(valuePair.getName());
    		builderWithKey.append(valuePair.getName());
    		builderWithKey.append(":");
    		builderWithInfo.append(valuePair.getValue());
    	}
    	...
    	//Loger.i("LYM", "tokenvalue"+App.sPhoneIMEI);
    	Loger.i("TEST","sRequestParams.toString()->"+params.toString());
