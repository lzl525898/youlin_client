...
public class JsonHttpResponseHandler extends TextHttpResponseHandler {
    ...
    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
        ...
        //Loger.i("youlin", "AsyncHttpClient2222222222222222--->");
    }
    ...
    public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
        ...
        //Loger.i("youlin", "AsyncHttpClient3333333333333333333--->");
    }
    ...
    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
        ...
        //Loger.i("youlin", "AsyncHttpClient444444444444444444--->");
    }
    ...
    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
        ...
        //Loger.i("youlin", "AsyncHttpClient55555555555555--->");
    }
                    ...
                    try {
                        ...
                        postRunnable(new Runnable() {
                            ...
                            public void run() {
                            	...
                            	//Loger.i("youlin", "AsyncHttpClient888888888888888888888--->");
                ...
                public void run() {
                    try {
                        ...
                        postRunnable(new Runnable() {
                            ...
                            public void run() {
                                // In RFC5179 a null value is not a valid JSON
                            	//Loger.i("youlin", "AsyncHttpClient99999999999999999999--->");
                                if (!useRFC5179CompatibilityMode && jsonResponse == null) {
