...
public class VerificationTimeButtonForget extends Button implements OnClickListener {
	...
	public VerificationTimeButtonForget(Context context) {
		super(context);
		this.context = context;
		setOnClickListener(this);
	}

	public VerificationTimeButtonForget(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		setOnClickListener(this);
	}
	...
	Handler han = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			VerificationTimeButtonForget.this.setText(time / 1000 + textafter);
			time -= 1000;
			if (time >= 0){
				VerificationTimeButtonForget.this.setBackgroundResource(R.drawable.bg_forget_pwd);
			}
			
			if (time < 0) {
				VerificationTimeButtonForget.this.setEnabled(true);
				VerificationTimeButtonForget.this.setBackgroundResource(R.drawable.bg_get_verification_code);
				VerificationTimeButtonForget.this.setText(textbefore);
				clearTimer();
				bClearInfo = true;
	...
	public void setOnClickListener(OnClickListener l) {
		...
		if (l instanceof VerificationTimeButtonForget) {
	...
	public void onClick(View v) {
		if(!NetworkMonitorService.bNetworkMonitor){
			...
			return;
		}else if(!ForgetPasswordActivity.bEditPhoneStatus){
	...
	/** * 设置计时时候显示的文本 */
	public VerificationTimeButtonForget setTextAfter(String text1) {
		this.textafter = text1;
		return this;
	}

	/** * 设置点击之前的文本 */
	public VerificationTimeButtonForget setTextBefore(String text0) {
	 ...
	 *            时间 默认毫秒
	 */
	public VerificationTimeButtonForget setLenght(long lenght) {
		this.lenght = lenght;
		return this;
	}
}