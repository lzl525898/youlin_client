...
import com.nfs.youlin.utils.BitmapCache.ImageCallback;
...
//			holder.imageView.setImageBitmap( NewTopicAlbumActivity.contentList.get(position).imageList.get(0).getBitmap());
