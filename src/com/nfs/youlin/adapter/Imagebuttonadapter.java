...
public class Imagebuttonadapter extends BaseAdapter{
	...
	public Imagebuttonadapter(Context context, List<Map<String, Object>> list, 
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder = null;
		 if (convertView == null) {    
	            ...
	            holder.num_Text = (TextView) convertView.findViewById(Toelement[1]);
		...
		holder.num_Text.setText(data.get(position).get(fromstring[1]).toString());
		 ...
		 if(data.get(position).get(fromstring[2]).equals("1")){
			 ...
			 holder.num_Text.setTextColor(0xffffba02);
			 ...
			 holder.num_Text.setTextColor(0xff909090);
