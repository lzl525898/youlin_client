...
public class SendActivityAddress extends Activity implements
OnGetGeoCoderResultListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addressEt.setText(SendActivity.sendAddressTv.getText());
...
//				build.zoom(17.0f);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.finish:
			...
			SendActivity.sendAddressTv.setText(addressStr);
			finish();
			InputMethodManager inputMethodManager = (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
			inputMethodManager.hideSoftInputFromWindow(SendActivityAddress.this.getCurrentFocus().getWindowToken(),InputMethodManager.HIDE_NOT_ALWAYS);
			break;
		default:
			break;
		}
	...
	public void onGetReverseGeoCodeResult(ReverseGeoCodeResult arg0) {
		...
		popWindow.setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss() {
				// TODO Auto-generated method stub
				new BackgroundAlpha(1f, SendActivityAddress.this);
			}
		});
	}
}
