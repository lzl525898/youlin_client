...
public class MD5Util {  
     ...
     * @throws UnsupportedEncodingException 
     */  
    public static String getEncryptedPwd(String password,String phone)  
        ...
        md.update(password.getBytes("UTF-8"));  
        byte[] digest = md.digest();
        finalpassword = (byteToHexString(digest)+phone).trim();
        Loger.d("test4", "finalpassword="+finalpassword);
        pwd = finalpassword.getBytes("UTF-8");
        
//        MessageDigest md1 = null;  
//        md1 = MessageDigest.getInstance("MD5");    
        md.update(pwd);  
        byte[] finalmd5 = md.digest();
        
        return byteToHexString(finalmd5);  
    }  
}  