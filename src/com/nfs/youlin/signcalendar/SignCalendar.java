...
//      addView(dividerContainer);  //hyy
    ...
    private void initWeekdays() {
    	...
    	LinearLayout weekdaysOutContainer = new LinearLayout(getContext());
    	weekdaysOutContainer.setOrientation(LinearLayout.HORIZONTAL);
    	weekdaysOutContainer.setBackgroundColor(mContext.getResources().getColor(R.color.cal_weekdays_background));
    	LinearLayout.LayoutParams containeroutParams = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        containeroutParams.height = (int) mContext.getResources().getDimension(R.dimen.cal_weekdays_height);
        weekdaysOutContainer.setLayoutParams(containeroutParams);
        ...
        weekdaysOutContainer.addView(weekdaysContainer);
        addView(weekdaysOutContainer);
    }
    ...
    private void initDatePager() {
        ...
        LinearLayout.LayoutParams containerParams = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
        containerParams.height = (int) mContext.getResources().getDimension(R.dimen.cal_viewpager_height);
        containerParams.leftMargin = (int) mContext.getResources().getDimension(R.dimen.cal_pager_h_margin);
        containerParams.rightMargin = (int) mContext.getResources().getDimension(R.dimen.cal_pager_h_margin);
...
//        pagerParams.rightMargin = (int) mContext.getResources().getDimension(R.dimen.cal_pager_h_margin);
        pagerParams.height = (int) mContext.getResources().getDimension(R.dimen.cal_viewpager_height);
