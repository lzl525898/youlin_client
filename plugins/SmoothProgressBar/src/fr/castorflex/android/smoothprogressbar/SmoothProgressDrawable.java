...
import fr.castorflex.android.smoothprogressbar.sample.R;
...
public class SmoothProgressDrawable extends Drawable implements Animatable {
	...
	private SmoothProgressDrawable(Interpolator interpolator, int sectionsCount, int separatorLength, int[] colors, float strokeWidth, float speed,
			...
			boolean progressiveStartActivated, Drawable backgroundDrawable) {
		mRunning = false;
	...
	public static class Builder {
		...
		public SmoothProgressDrawable build() {
			...
			SmoothProgressDrawable ret = new SmoothProgressDrawable(mInterpolator, mSectionsCount, mStrokeSeparatorLength, mColors, mStrokeWidth,
					mSpeed, mProgressiveStartSpeed, mProgressiveStopSpeed, mReversed, mMirrorMode, mOnProgressiveStopEndedListener,
