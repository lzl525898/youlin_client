...
public abstract class HXSDKHelper {
    ...
    public synchronized boolean onInit(Context context){
        ...
        Loger.d(TAG, "process app name : " + processAppName);
        ...
        Loger.d(TAG, "initialize EMChat SDK");
    ...
    protected void initHXOptions(){
        Loger.d(TAG, "init HuanXin Options");
        ...
        while (i.hasNext()) {
            ...
            try {
                if (info.pid == pID) {
                    ...
                    // Loger.d("Process", "Id: "+ info.pid +" ProcessName: "+
                ...
                // Loger.d("Process", "Error>> :"+ e.toString());
            }
        }
        return processName;
    }
