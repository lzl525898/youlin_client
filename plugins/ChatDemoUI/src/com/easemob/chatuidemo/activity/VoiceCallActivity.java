...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
	...
	public static Context VoiceCallContext;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		neighborimg = (ImageView) findViewById(R.id.swing_card);
...
//		    Picasso.with(this) //
//            .load(search.findPointFamilyandUserimg(Long.parseLong(username)).get(0)) //
//            .placeholder(R.drawable.account) //
//            .error(R.drawable.account) //
//            .fit() //
//            .tag(this) //
//            .into(neighborimg);
		    imageLoader.displayImage(search.findPointFamilyandUserimg(Long.parseLong(username)).get(0), neighborimg, App.options_account);
		}
