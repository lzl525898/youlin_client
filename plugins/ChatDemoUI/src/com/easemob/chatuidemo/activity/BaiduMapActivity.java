...
public class BaiduMapActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		instance = this;
		Loger.d("hyytest"," Baidu->onCreate");
		...
		initMapView();
		if (latitude == 0) {
		    Loger.d("hyytest"," Baidu->latitude == 0");
	...
	public class MyLocationListenner implements BDLocationListener {
		...
		//	location.setLongitude(127.513645);
		//	location.setLatitude(36.000000);
			
			Loger.d("hyytest", "On location change received:" + location);
			Loger.d("hyytest", "addr:" + location.getAddrStr());
