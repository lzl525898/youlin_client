...
public final class CustomActivityOnCrash {
    ...
    private static int defaultErrorActivityDrawableId = R.drawable.ic_launcher;
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(CustomActivityOnCrash.EXTRA_IMAGE_DRAWABLE_ID, R.drawable.ic_launcher);
    }
