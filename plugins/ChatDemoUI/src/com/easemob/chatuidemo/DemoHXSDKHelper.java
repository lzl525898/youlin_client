    ...
    protected void initEventListener() {
        eventListener = new EMEventListener() {
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                case EventNewMessage:
                    ...
                    Loger.d("hyytest", "global EventNewMessage");
                ...
                case EventOfflineMessage:
                    if(activityList.size() <= 0){
                        Loger.d("hyytest", "global EventOfflineMessage");
                ...
                case EventDeliveryAck:
                    Loger.d("hyytest", "global EventDeliveryAck");
                    message.setDelivered(true);
                    break;
                case EventReadAck:
                    Loger.d("hyytest", "global EventReadAck");
        ...
        EMChatManager.getInstance().addChatRoomChangeListener(new EMChatRoomChangeListener(){
            ...
            public void onChatRoomDestroyed(String roomId, String roomName) {
                ...
                Loger.i("info","onChatRoomDestroyed="+roomName);
            }

            @Override
            public void onMemberJoined(String roomId, String participant) {
                showToast("member : " + participant + " join the room : " + roomId);
                Loger.i("info", "onmemberjoined="+participant);
            ...
            public void onMemberExited(String roomId, String roomName,
                ...
                Loger.i("info", "onMemberExited="+participant);
            ...
            public void onMemberKicked(String roomId, String roomName,
                ...
                Loger.i("info", "onMemberKicked="+participant);
