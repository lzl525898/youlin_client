...
public class PhotoViewAttacher implements IPhotoView, View.OnTouchListener,
	...
	public PhotoViewAttacher(Context context,final ImageView imageView) {
			...
			mGestureDetector = new GestureDetector(imageView.getContext(),
					new GestureDetector.SimpleOnGestureListener() {
						...
						public void onLongPress(MotionEvent e) {
                            ...
                            if(view==null){
                                view=LayoutInflater.from(mContext).inflate(R.layout.save_picture_huanxin, null);
                            }
...
//                                        }
                                    ...
                                    Toast.makeText(mContext, "保存路径为:"+dirPath+"/"+filePath, 1).show();
                                    popWindow.dismiss();
                                }
                            });
						}
