...
/*************************hyy**********************/
    ...
    private void setupViewsFromStyles(Activity activity, View headerView) {
        ...
        Drawable bg = styleAttrs.hasValue(R.styleable.PullToRefreshHeader_ptrHeaderBackground1)
                ? styleAttrs.getDrawable(R.styleable.PullToRefreshHeader_ptrHeaderBackground1)
